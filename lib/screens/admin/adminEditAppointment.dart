...
class AdminEditAppointment extends StatefulWidget {
  ...
  @override
  _AdminEditAppointmentState createState() => _AdminEditAppointmentState();
}

class _AdminEditAppointmentState extends State<AdminEditAppointment> {
  String datePicked;
  String timePicked;
  String dokterPicked;
  ...
  load()async{
    try {
      ...
      for (var i in listJadwal){
        if (i["waktu_mulai"].split("T")[0]==this.datePicked){
    ...
    try {
      ...
      if (passed){
        ...
        var response =  await http.patch(
          'http://api-dentis.herokuapp.com/appointment-detail/${widget.idAppointment}/', 
          headers: {
        ...
        Fluttertoast.showToast(
          msg: "Appointment berhasil diubah",
