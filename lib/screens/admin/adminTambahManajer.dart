...
class AdminTambahManajer extends StatefulWidget {
  @override
  _AdminTambahManajerState createState() => _AdminTambahManajerState();
}

class _AdminTambahManajerState extends State<AdminTambahManajer> {
  double height=0;
  ...
  submit()async{
    ...
    if (pass){
      ...
      var response =  await http.post(
        'http://api-dentis.herokuapp.com/manajer/',
        headers: {
